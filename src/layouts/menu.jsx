...
const renderMenu = (t) => {
  ...
  const menu = [
    ...
    },
    {
      ...
      level: 0,
      children: [
        { path: '/key-manager/secrets', name: t('Secrets'), key: 'barbicanSecrets', level: 1 },
        { path: '/key-manager/containers', name: t('Containers'), key: 'barbicanContainers', level: 1 },
      ],
    },
    {
      path: '/infra-optim',
      ...
      level: 0,
      children: [
        { path: '/infra-optim/goals', name: t('Goals'), key: 'watcherGoals', level: 1 },
        { path: '/infra-optim/strategies', name: t('Strategies'), key: 'watcherStrategies', level: 1 },
        { path: '/infra-optim/audit-templates', name: t('Audit Templates'), key: 'watcherAuditTemplates', level: 1 },
        { path: '/infra-optim/audits', name: t('Audits'), key: 'watcherAudits', level: 1 },
        { path: '/infra-optim/action-plans', name: t('Action Plans'), key: 'watcherActionPlans', level: 1 },
        { path: '/infra-optim/actions', name: t('Actions'), key: 'watcherActions', level: 1 },
        { path: '/infra-optim/system-info', name: t('System Info'), key: 'watcherSystemInfo', level: 1 },
        { path: '/infra-optim/ui-settings', name: t('UI Settings'), key: 'watcherUISettings', level: 1 },
      ],
    },
  ];
  return menu;
