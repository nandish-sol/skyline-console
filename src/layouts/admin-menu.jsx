  ...
  const menu = [
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: '/monitor-center/monitoring-admin',
          name: t('Monitoring'),
          key: 'monitoringAdmin',
          level: 1,
          children: [],
    ...
    },
    {
      ...
      children: [
        {
          path: '/infra-optim/goals-admin',
          name: t('Goals'),
          key: 'watcherGoalsAdmin',
          level: 1,
          children: [
            {
              path: /^\/infra-optim\/goals-admin\/detail\/.[^/]+$/,
              name: t('Goal Detail'),
              key: 'watcherGoalDetailAdmin',
              level: 2,
              routePath: '/infra-optim/goals-admin/detail/:id',
            },
          ],
        },
        {
          path: '/infra-optim/strategies-admin',
          name: t('Strategies'),
          key: 'watcherStrategiesAdmin',
          level: 1,
          children: [
            {
              path: /^\/infra-optim\/strategies-admin\/detail\/.[^/]+$/,
              name: t('Strategy Detail'),
              key: 'watcherStrategyDetailAdmin',
              level: 2,
              routePath: '/infra-optim/strategies-admin/detail/:id',
            },
          ],
        },
        {
          path: '/infra-optim/audit-templates-admin',
          name: t('Audit Templates'),
          key: 'watcherAuditTemplatesAdmin',
          level: 1,
          children: [
            {
              path: /^\/infra-optim\/audit-templates-admin\/detail\/.[^/]+$/,
              name: t('Audit Template Detail'),
              key: 'watcherAuditTemplateDetailAdmin',
              level: 2,
              routePath: '/infra-optim/audit-templates-admin/detail/:id',
            },
          ],
        },
        {
          path: '/infra-optim/audits-admin',
          name: t('Audits'),
          key: 'watcherAuditsAdmin',
          level: 1,
          children: [
            {
              path: /^\/infra-optim\/audits-admin\/detail\/.[^/]+$/,
              name: t('Audit Detail'),
              key: 'watcherAuditDetailAdmin',
              level: 2,
              routePath: '/infra-optim/audits-admin/detail/:id',
            },
          ],
        },
        {
          path: '/infra-optim/action-plans-admin',
          name: t('Action Plans'),
          key: 'watcherActionPlansAdmin',
          level: 1,
          children: [
            {
              path: /^\/infra-optim\/action-plans-admin\/detail\/.[^/]+$/,
              name: t('Action Plan Detail'),
              key: 'watcherActionPlanDetailAdmin',
              level: 2,
              routePath: '/infra-optim/action-plans-admin/detail/:id',
            },
          ],
        },
        {
          path: '/infra-optim/actions-admin',
          name: t('Actions'),
          key: 'watcherActionsAdmin',
          level: 1,
          children: [
            {
              path: /^\/infra-optim\/actions-admin\/detail\/.[^/]+$/,
              name: t('Action Detail'),
              key: 'watcherActionDetailAdmin',
              level: 2,
              routePath: '/infra-optim/actions-admin/detail/:id',
            },
          ],
        },
      ],
